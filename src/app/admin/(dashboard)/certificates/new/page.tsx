  ...
  const onSubmit = async (data: CertificateFormData) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(errorData.error || 'فشل إضافة الشهادة');
      }
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">إضافة شهادة جديدة</h1>
            <p className="text-gray-600 mt-1">أضف شهادة جودة أو اعتماد جديدة</p>
          </div>
        </div>
      </div>
