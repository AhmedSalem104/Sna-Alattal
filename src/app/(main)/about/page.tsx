          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                ...
                {/* Experience Badge */}
                <div className="relative bottom-0 left-4 mt-4 md:absolute md:-bottom-6 md:-left-6 md:mt-0 bg-primary text-neutral-900 p-4 sm:p-5 md:p-6 rounded-2xl shadow-xl inline-block">
            ...
            >
              ...
              <div className="flex flex-wrap gap-8">
                <div>
                  ...
                  <div className="text-neutral-600">{t('stats.projects')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary">300+</div>
                  <div className="text-neutral-600">{t('stats.clients')}</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary">15+</div>
                  <div className="text-neutral-600">{t('stats.countries')}</div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">{t('vision.title')}</h3>
              <p className="text-neutral-700 leading-relaxed">{t('vision.content')}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">{t('mission.title')}</h3>
              <p className="text-neutral-700 leading-relaxed">{t('mission.content')}</p>
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="bg-neutral-50 p-6 rounded-2xl border border-neutral-200 hover:border-primary/50 transition-colors group"
              >
                ...
                <h3 className="text-xl font-bold text-neutral-900 mb-2">{t(value.titleKey)}</h3>
                <p className="text-neutral-600">{t(value.descKey)}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-neutral-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-neutral-600">{t('timeline.subtitle')}</p>
          </motion.div>
                  ...
                  >
                    <div className="flex-1 pl-12 md:pl-0">
                      <div className="bg-white p-4 md:p-6 rounded-xl border border-neutral-200 shadow-sm">
                        ...
                        <p className="text-neutral-700 text-sm md:text-base">{getEvent(item)}</p>
                      </div>
                    </div>
